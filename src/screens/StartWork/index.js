...
const StartWork = props => {
  ...
  const ImageData = data => {
    console.log('item we have recieving herer' ,  data);
    return (
        <View style={styles.viewStyle}>
      <TouchableOpacity
        onPress={() => props.navigation.navigate('NewRestroom' , taskData)}
        ...
        <View>
          <Text
            ...
            Location : {data?.item?.restroom_id}
          </Text>
          <Text
            style={{
              color: 'black',
        ...
        <View>
          <Text
            ...
            <Text style={{color:"#397421" , fontFamily:"Roboto-Medium" , fontSize:ResponsiveSize(18) , textAlign:"center" , padding:10}}>Upload photos after work</Text>
            </View>
    );
  };
  return (
    <View>
      ...
      <View style={{padding: ResponsiveSize(20)}}>
        ...
        <FlatList data={taskData} renderItem={ImageData}  />
      </View>
    </View>
  );
};
